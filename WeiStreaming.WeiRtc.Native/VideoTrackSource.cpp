...
VideoTrackSource::VideoTrackSource(
    ...
    : _pipRender(pipCanvas), webrtc::VideoTrackSource(false) {
...
void VideoTrackSource::Close() {
    _videoCapturer->RemoveSink(const_cast<VideoRender*>(&_pipRender));
    _videoCapturer->StopCapture();
    delete _videoCapturer;
}
